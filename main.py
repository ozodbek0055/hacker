...
app = Client("my_account",
             api_id='16882754',
             api_hash='d81719ee215fb594511eba9206f5637e'
             )
...
veter = ['Затянулось', 'небо🥀', 'одеялом💔', 'да', 'День', 'чернее', 'ночи', 'солнца🌕', 'стало', 'мало🌒',
         'нам👩‍❤️‍👨', 'Ветер😻', 'завывает', 'диким', 'воем',
         'облака', 'Сердце💔', 'тихо', 'плачет💔🥀', 'и', 'болит❤️‍🩹', 'но', 'как', 'Но', 'как', 'нам', 'не',
         'хватало💔', 'на', 'двоих👫', 'одной', 'любви❤️',
